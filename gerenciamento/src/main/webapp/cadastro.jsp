                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h3 class="h4 text-gray-900 mb-4">${msg}</h3>
                                    </div>
                                    <form action="<%=request.getContextPath()%>/servlet_cadastro_e_atualizacao_usuario" method="post" 
						name="formulario_cadastro" class="signin-form" id="formulario">
